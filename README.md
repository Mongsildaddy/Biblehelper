...
- 한국어 gloss 커버리지: 본문 낱말 수 기준 **구약 91.5% · 신약 87.6%** (롱테일 진행 중).
...
- 상세 정의 한국어화 (상위 500개 낱말) — 히브리어 361개는 PD 원문 기준으로 전량 재작성
- 검색엔진 등록용 메타태그·sitemap·robots, GA4 방문 통계
- 낱말×책 AI 요약 244개 내장 + 서버 연결 시 실시간 생성

## 남은 작업
1. 한국어 gloss 롱테일 번역 → 커버리지 95%+ (현재 구약 91.5% / 신약 87.6%)
2. 상세 정의 한국어화 확대 (현재 상위 500개: 히브리어 361 + 헬라어 139)
...
- 옛 정의를 번역했던 한국어 상세정의 361개는 파생물이므로 폐기 후 새 원문 기준 재작성
  → **361개 전량 재작성 완료.** 옛 판본에서 유래한 문장은 남아 있지 않다.
